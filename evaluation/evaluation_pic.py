...
def draw_picture(time_path, result_path):
  ...
  plt.suptitle("Average-Recall-Top-N(by Created Time vs Our Alogrithm)", fontsize=fontsize)
  plt.subplot(121)
  ...
  plt.xlabel("Top-N", fontsize=fontsize)  
  plt.ylabel("value(Average Recall)",fontsize=fontsize)  
